...
print(f"Li: {round(percent_li)}.000% ({str(len(Li_votes))})") 
print(f"O'Tooley: {round(percent_otooley)}.000% ({str(len(OTooley_votes))})") 
print("----------------------------")  
...
output= ("Election Results" + "\n" + "-------------------------------"+ "\n" +  "Total Votes: " + str(total_votes) + "\n" + "-------------------------------" + "\n" + "Khan: " + str(round(percent_khan_votes)) + ".000%  " + str(len(Khan_votes)) + "\n" + "Correy: " + str(round(percent_correy)) + ".000%  " + str(len(Correy_votes)) + "\n" + "Li: " + str(round(percent_li)) + ".000%  " + str(len(Li_votes)) + "\n" + "O'Tooley: " + str(round(percent_otooley)) + ".000%  " + str(len(OTooley_votes)) + "\n" + "-------------------------------" + "\n" + "Winner: Khan")
